      ...
      {isOpen && (
        ...
        >
          ...
          <motion.div
            ...
            className="w-full max-w-2xl rounded-xl border border-slate-800 bg-slate-900 shadow-2xl shadow-black/50 flex flex-col max-h-[90vh]"
          >
            {/* Header Fixo */}
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500">
                    Defina os detalhes para gerar testes
                  </p>
                </div>
              </div>
              <Button
                ...
                <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
                  ...
                  <div>
                    <label
                      ...
                      className={`${labelClasses} text-amber-500`}
                    >
                      Fluxos Alternativos
                    </label>
                    <TextArea
