      ...
      {isOpen && (
        ...
        >
          ...
          <motion.div
            ...
            className="w-full max-w-2xl rounded-xl border border-slate-800 bg-slate-900 shadow-2xl shadow-black/50 max-h-[90vh] overflow-y-auto flex flex-col"
          >
            {/* Header Fixo */}
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500">
                    Atualize as informações do artefato
                  </p>
                </div>
              </div>
              <Button
