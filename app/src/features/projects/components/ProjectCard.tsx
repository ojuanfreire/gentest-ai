  ...
  return (
    ...
    >
      <div className="flex items-start justify-between">
        ...
        <button
          className="rounded-full p-1 text-slate-400 opacity-0 transition-all hover:bg-slate-700 hover:text-white group-hover:opacity-100"
          aria-label="Opções do projeto"
          onClick={(e) => {
            e.stopPropagation();
            alert("Menu de opções do projeto (Editar/Excluir) a implementar");
          }}
        >
